...
public class SecurityTextContainer
{
	...
	private static bool IsValidUri(string value, params string[] uriSchemeRestriction)
	{
	...
	private static bool IsValidUrl(string value, UriValidationOptions options)
	{
		if (Uri.TryCreate(value, UriKind.Absolute, out var validatedUri))
		{
